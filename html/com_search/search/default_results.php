...
<?php foreach ($this->results as $result) : ?>
	...
	<?php if ($result->section) : ?>
		<dd class="result-category">
			<span class="mr-4">
				<i class="fa fa-folder-open-o" aria-hidden="true"></i> (<?php echo $this->escape($result->section); ?>)
			</span>
			<?php if ($this->params->get('show_date')) : ?>
				<span class="result-created<?php echo $this->pageclass_sfx; ?>">
					<i class="fa fa-calendar-o" aria-hidden="true"></i> <?php echo JText::sprintf('JGLOBAL_CREATED_DATE_ON', $result->created); ?>
				</span>
			<?php endif; ?>
		</dd>
	<?php endif; ?>	
