	...
	<?php if (!empty($options)) : ?>
		<?php foreach ($options as $i => $option) : ?>
			<?php
				...
				$option->class  = !empty($option->class) ? 'class="form-check-input ' . $option->class : 'class="form-check-input"';
				$option->class  = trim($option->class . ' ' . $disabled);
				$optionClass    = !empty($option->class) ? 'class="form-check-label ' . $option->class . '"' : 'class="form-check-label"';
