	...
	<?php if (($this->params->get('address_check') > 0) &&
		...
		<dt>
			<span class="<?php echo $this->params->get('marker_class'); ?>">
				<?php echo JText::_('TPL_BOOTSTRAP4_CONTACT_ADDRESS'); ?>
			</span>
		</dt>
...
<?php if ($this->contact->email_to && $this->params->get('show_email')) : ?>
	<dt>
		<span class="<?php echo $this->params->get('marker_class'); ?>" itemprop="email">
			<?php echo JText::_('TPL_BOOTSTRAP4_CONTACT_EMAIL'); ?>
		</span>
	</dt>
	<dd>
...
<?php if ($this->contact->telephone && $this->params->get('show_telephone')) : ?>
	<dt>
		<span class="<?php echo $this->params->get('marker_class'); ?>">
			<?php echo JText::_('TPL_BOOTSTRAP4_CONTACT_PHONE'); ?>
		</span>
	</dt>
	<dd>
...
<?php if ($this->contact->fax && $this->params->get('show_fax')) : ?>
	<dt>
		<span class="<?php echo $this->params->get('marker_class'); ?>">
			<?php echo JText::_('TPL_BOOTSTRAP4_CONTACT_FAX'); ?>
		</span>
	</dt>
	<dd>
...
<?php if ($this->contact->mobile && $this->params->get('show_mobile')) : ?>
	<dt>
		<span class="<?php echo $this->params->get('marker_class'); ?>">
			<?php echo JText::_('TPL_BOOTSTRAP4_CONTACT_MOBILE'); ?>
		</span>
	</dt>
	<dd>
