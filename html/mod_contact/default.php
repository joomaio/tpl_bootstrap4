...
?>
<div class="mod-contact-form <?php echo $moduleclass_sfx; ?>">
	<form id="contact-form" action="<?php echo JRoute::_('index.php?option=com_contact&view=contact&id=1'); ?>" method="post" class="needs-validation" novalidate>
