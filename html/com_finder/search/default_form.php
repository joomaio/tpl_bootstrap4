...
?>
<form id="finder-search" action="<?php echo JRoute::_($this->query->toUri()); ?>" method="get" class="">
	...
	<?php endif; ?>
	<div class="form-inline smart-search-word">
		<label for="q" class="d-none">
			<?php echo JText::_('COM_FINDER_SEARCH_TERMS'); ?>
		</label>
		<div class="input-group">
			<input type="text" name="q" id="q" size="30" value="<?php echo $this->escape($this->query->input); ?>" class="form-control" placeholder="<?php echo JText::_('COM_FINDER_SEARCH_TERMS'); ?>"/>
		...
		<?php if ($this->params->get('show_advanced', 1)) : ?>
			<a href="#advancedSearch" data-toggle="collapse" class="ml-3 btn btn-outline-primary">
	...
	<?php if ($this->params->get('show_advanced', 1)) : ?>
		<div id="advancedSearch" class="collapse<?php if ($this->params->get('expand_advanced', 0)) echo ' in'; ?>">
			...
			<?php endif; ?>
			<div id="finder-filter-window" class="finder-filters">
