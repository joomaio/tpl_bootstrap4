...
<?php else : ?>
	...
	<div class="newsfeed<?php echo $this->pageclass_sfx; ?><?php echo $direction; ?>">
		...
		<?php endif; ?>
		<h1 class="my-4 <?php echo $direction; ?>">
			<?php if ($this->item->published == 0) : ?>
				<span class="label label-warning"><?php echo JText::_('JUNPUBLISHED'); ?></span>
			<?php endif; ?>
			<?php echo JText::_('TPL_BOOTSTRAP4_NEWS_FEED_TITLE'); ?>
		...
		<?php if ($this->params->get('show_feed_description')) : ?>
			<div class="feed-description mb-3">
		...
		<?php if (!empty($this->rssDoc[0])) : ?>
			<ol class="feedlist list-striped">
				<?php for ($i = 0; $i < $this->item->numarticles; $i++) : ?>
					...
					<li>
						...
						<?php else : ?>
							<h5 class="feed-link"><?php echo trim($this->rssDoc[$i]->title); ?></h5>
						<?php endif; ?>
