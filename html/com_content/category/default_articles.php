...
?>
<form action="<?php echo htmlspecialchars(JUri::getInstance()->toString()); ?>" method="post" name="adminForm" id="adminForm" class="">
<?php if ($this->params->get('filter_field') !== 'hide' || $this->params->get('show_pagination_limit')) : ?>
	<div class="category-list-filters row clearfix">
		...
		<?php if ($this->params->get('filter_field') !== 'hide') : ?>
			<div class="col mb-3">
				...
				<?php elseif ($this->params->get('filter_field') === 'month') : ?>
					<select name="filter-search" id="filter-search" onchange="document.adminForm.submit();" class="form-control">
		...
		<?php if ($this->params->get('show_pagination_limit')) : ?>
			<div class="col mb-3">
				<div class="limitbox form-inline float-md-right">
					<label for="limit" class="element-invisible mr-2">
