...
<div class="card mb-4">	
	<div class="card-header">
		<?php if ($params->get('show_title')) : ?>
			<h2 class="item-title mb-0" itemprop="headline">
	...
	<div class="card-footer text-muted">
		...
		<span><?php echo JText::_('TPL_BOOTSTRAP4_AUTHOR_LABEL'); ?> <a href="<?php echo JRoute::_('index.php?option=com_author&author_id=' . $this->item->created_by, false); ?>"><?php echo $this->item->author; ?></a></span>
	</div>
</div>